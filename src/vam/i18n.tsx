...
const TRANSLATIONS: Translations = {
  ...
  'nav.realtime_inquiry': { en: 'Real-time Inquiry', ko: '실시간 조회' },
  ...
  'onb.subtitle': { en: 'Unified lifecycle management for institutional partners. Onboard, configure VA rails, and manage credentials in one plane.', ko: '기관 파트너를 위한 통합 수명주기 관리. 온보딩, VA 레일 구성, 자격 증명 관리를 한 곳에서.' },
  ...
  'onb.institutional_partners': { en: 'Institutional Partners', ko: '기관 파트너' },
  ...
  'tx.subtitle': { en: 'Real-time VA inquiry, transaction ledger, batch processing, and exception resolution.', ko: '실시간 VA 조회, 거래 원장, 일괄 처리, 예외 해결.' },
  ...
  'tx.realtime_inquiry': { en: 'Real-time VA Inquiry', ko: '실시간 VA 조회' },
  'tx.cross_reference': { en: 'Cross-Reference Bank XYZ Core vs Shadow Rails', ko: 'Bank XYZ 코어 vs 섀도우 레일 교차 참조' },
  'tx.query': { en: 'Query', ko: '조회' },
  'tx.enter_va': { en: 'Enter VA Number (e.g. 88001123456)', ko: 'VA 번호 입력 (예: 88001123456)' },
  'tx.shadow_balance': { en: 'Shadow Balance', ko: '섀도우 잔액' },
  'tx.core_balance': { en: 'Core Balance', ko: '코어 잔액' },
  'tx.recent_activity': { en: 'Recent Activity', ko: '최근 활동' },
  'tx.metadata': { en: 'Metadata', ko: '메타데이터' },
  'tx.no_va_found': { en: 'No VA found for', ko: 'VA를 찾을 수 없습니다' },
